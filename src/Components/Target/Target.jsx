...
const Target = () => {
    return (
        <div className={c.Target}>
            ...
            <p className={c.Target__text}>Узнать больше о проекте можно тут <i class="fas fa-arrow-right"></i> <a className={c.Target__link} href="https://xn----9sbifbsmb4avd9fl1be.xn--p1ai/">добрые-крышечки.рф</a>
            </p>
        ...
        <p className={c.Target__text}>Узнать больше о проекте можно тут <i class="fas fa-arrow-right"></i> <a className={c.Target__link} href="https://sobirator.ru/">sobirator.ru</a>
                    </p>
